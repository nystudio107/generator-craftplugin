...
namespace modules\<%= pluginDirName %>\utilities;

use modules\<%= pluginDirName%>\<%= pluginHandle %>;
use modules\<%= pluginDirName %>\assetbundles\<%= utilityName[index].toLowerCase() %>utility\<%= utilityName[index] %>UtilityAsset;
...
<% } -%>
    ...
    {
        return Craft::getAlias("@modules/<%= pluginDirName %>/assetbundles/<%= utilityName[index].toLowerCase() %>utility/dist/img/<%= utilityName[index] %>-icon.svg");
    }
